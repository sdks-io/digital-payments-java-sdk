...
public class Datum {
     ...
     * @return Returns the List of OpeningHour
     */
     ...
     * An Array of the station’s opening hours. This may have opening and closing times in hours,
     * minutes and the day of the week.
     * @param openingHours Value for List of OpeningHour
     */
    ...
    public String toString() {
        return "Datum [" + "id=" + id + ", type=" + type + ", name=" + name + ", addr=" + addr
                + ", lat=" + lat + ", lon=" + lon + ", amen=" + amen + ", fuel=" + fuel + ", loc="
                + loc + ", mppStationId=" + mppStationId + ", doubleSiteId=" + doubleSiteId
                + ", openingHours=" + openingHours + ", telephone=" + telephone
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder openingHours(List<OpeningHour> openingHours) {
            this.openingHours = openingHours;
            return this;
        }
         ...
         */
        public Datum build() {
            return new Datum(id, type, name, addr, lat, lon, amen, fuel, loc, mppStationId,
                    doubleSiteId, openingHours, telephone, authorisationCode, mpPreauth);
        }
    }
}
