...
public class PrepareFuelingRequest {
     ...
     * @param  paymentDetails  PaymentDetails value for paymentDetails.
     ...
     * @param  deviceDetails  List of DeviceDetail value for deviceDetails.
     */
    public PrepareFuelingRequest(
            double latitude,
            double longitude,
     ...
     * Object containing Payment details
     * @param paymentDetails Value for PaymentDetails
     */
     ...
     * @return Returns the List of DeviceDetail
     */
     ...
     * Object containing device details
     * @param deviceDetails Value for List of DeviceDetail
     */
    ...
    public static class Builder {
        ...
        public Builder(double latitude, double longitude, String stationId, String pumpId,
                String sourceApplication, PaymentDetails paymentDetails) {
            this.latitude = latitude;
            this.longitude = longitude;
            this.stationId = stationId;
            this.pumpId = pumpId;
         ...
         * @return Builder
         */
        public Builder deviceDetails(List<DeviceDetail> deviceDetails) {
            this.deviceDetails = deviceDetails;
            return this;
        }
