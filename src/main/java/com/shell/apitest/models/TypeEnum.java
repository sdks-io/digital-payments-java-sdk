...
public enum TypeEnum {
    ...
    private static TreeMap<Integer, TypeEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static TypeEnum constructFromInteger(Integer toConvert) throws IOException {
        TypeEnum enumValue = fromInteger(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given integer value.
     */
    public static TypeEnum fromInteger(Integer toConvert) {
    ...
    /**
     * Convert list of TypeEnum values to list of integer values.
     * @param toConvert The list of TypeEnum values to convert.
     * @return List of representative integer values.
     */
    public static List<Integer> toValue(List<TypeEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
