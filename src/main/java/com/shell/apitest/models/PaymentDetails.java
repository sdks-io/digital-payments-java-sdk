...
/**
 * This is a model class for PaymentDetails type.
 */
public class PaymentDetails {
    ...
    /**
     * Converts this PaymentDetails into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PaymentDetails [" + "paymentMethodId=" + paymentMethodId + ", paymentProperties="
                + paymentProperties + ", paymentCategory=" + paymentCategory + "]";
    }

    /**
     * Builds a new {@link PaymentDetails.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PaymentDetails.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PaymentDetails}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link PaymentDetails} object using the set fields.
         * @return {@link PaymentDetails}
         */
        public PaymentDetails build() {
            return new PaymentDetails(paymentMethodId, paymentProperties, paymentCategory);
        }
    }
}
