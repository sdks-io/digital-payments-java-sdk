 ...
 */
public final class ShellSmartPayAPIClient implements Configuration {
    ...
    private ShellSmartPayAPIClient(Environment environment, HttpClient httpClient,
    ...
    /**
     * Converts this ShellSmartPayAPIClient into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ShellSmartPayAPIClient [" + "environment=" + environment + ", httpClientConfig="
                + httpClientConfig + ", authentications=" + authentications + "]";
    }

    /**
     * Builds a new {@link ShellSmartPayAPIClient.Builder} object.
     * Creates the instance with the state of the current client.
     * @return a new {@link ShellSmartPayAPIClient.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ShellSmartPayAPIClient}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new ShellSmartPayAPIClient object using the set fields.
         * @return ShellSmartPayAPIClient
         */
        public ShellSmartPayAPIClient build() {
            ...
            return new ShellSmartPayAPIClient(environment, httpClient, httpClientConfig,
                    mppTokenModel, oAuthTokenPostModel, httpCallback);
        }
    }
}