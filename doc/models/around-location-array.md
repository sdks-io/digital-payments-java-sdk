...
|  --- | --- | --- | --- | --- | --- |
| `Data` | [`List<AroundLocationArrayDataItems>`](../../doc/models/around-location-array-data-items.md) | Required | An array of station objects | List<AroundLocationArrayDataItems> getData() | setData(List<AroundLocationArrayDataItems> data) |
